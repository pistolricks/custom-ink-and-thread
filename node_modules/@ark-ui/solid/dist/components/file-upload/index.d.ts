...
interface UseFileUploadProps extends Optional<Omit<fileUpload$1.Context, 'dir' | 'getRootNode'>, 'id'> {
}
interface UseFileUploadReturn extends Accessor<fileUpload$1.Api<PropTypes>> {
}
declare const useFileUpload: (props?: UseFileUploadProps) => UseFileUploadReturn;

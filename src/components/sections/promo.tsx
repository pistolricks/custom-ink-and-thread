...
const Promo: Component<PROPS> = props => {
        ...
        <div class="relative overflow-hidden bg-white">
            ...
            <div aria-hidden="true" class="absolute inset-0">
                <div class="absolute inset-0 mx-auto max-w-7xl overflow-hidden xl:px-8">
                    <img src="https://tailwindcss.com/plus-assets/img/ecommerce-images/home-page-02-sale-full-width.jpg"
            ...
            <section aria-labelledby="testimonial-heading"
                ...
                <div class="mx-auto max-w-2xl lg:max-w-none">
                    <h2 id="testimonial-heading" class="text-2xl font-bold tracking-tight text-gray-900">What are people
                        saying?</h2>
                    ...
                    <div class="mt-16 space-y-16 lg:grid lg:grid-cols-3 lg:gap-x-8 lg:space-y-0">
                        ...
                        <blockquote class="sm:flex lg:block">
                            ...
                            <div class="mt-8 sm:ml-6 sm:mt-0 lg:ml-0 lg:mt-10">
                                <p class="text-lg text-gray-600">I had to return a purchase that didn’t fit. The whole
                        ...
                        <blockquote class="sm:flex lg:block">
                            ...
                            <div class="mt-8 sm:ml-6 sm:mt-0 lg:ml-0 lg:mt-10">
                                <p class="text-lg text-gray-600">Now that I’m on holiday for the summer, I’ll probably
                                    order a few more shirts. It’s just so convenient, and I know the quality will always
                                    be there.</p>

    ...
    return (
        ...
        >
            ...
            <div class="relative h-56 bg-gray-200 dark:bg-gray-900">
                <img class="object-cover h-full w-full" src={coverSrc()} width="979" height="220" alt="Profile background" />
                {/* Close button */}
                <button
            ...
            <div class="relative px-4 sm:px-6 pb-8">
                ...
                <div class="-mt-16 mb-6 sm:mb-3">
                    <div class="flex flex-col items-center sm:flex-row sm:justify-between sm:items-end">
                        ...
                        <Avatar name={user()?.name} src={src()} class={'rounded-full bg-gray-3 size-24 ring-2 ring-white lg:size-32'}/>
                        </div>
                ...
                <header class="text-center sm:text-left mb-6">
                    ...
                    <div class="flex flex-wrap justify-center sm:justify-start space-x-4">
                        ...
                        <div class="flex items-center">
                            ...
                            <a class="text-sm font-medium whitespace-nowrap text-violet-500 hover:text-violet-600 dark:hover:text-violet-400 ml-2" href="#0">
                                carolinmcneail.com
                            </a>
                        </div>
                    </div>
                ...
                <div class="relative mb-6">
                    ...
                    <ul class="relative text-sm font-medium flex flex-nowrap -mx-4 sm:-mx-6 lg:-mx-8 overflow-x-scroll no-scrollbar">
                        <li class="mr-6 last:mr-0 first:pl-4 sm:first:pl-6 lg:first:pl-8 last:pr-4 sm:last:pr-6 lg:last:pr-8">
                            <a class="block pb-3 text-violet-500 whitespace-nowrap border-b-2 border-violet-500" href="#0">
                                General
                            </a>
                        </li>
                        <li class="mr-6 last:mr-0 first:pl-4 sm:first:pl-6 lg:first:pl-8 last:pr-4 sm:last:pr-6 lg:last:pr-8">
                            <a class="block pb-3 text-gray-500 dark:text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 whitespace-nowrap" href="#0">
                                Connections
                            </a>
                        </li>
                        <li class="mr-6 last:mr-0 first:pl-4 sm:first:pl-6 lg:first:pl-8 last:pr-4 sm:last:pr-6 lg:last:pr-8">
                            ...
                            <div class="grid xl:grid-cols-2 gap-4">
                                ...
                                <div class="bg-white dark:bg-gray-900 p-4 border border-gray-200 dark:border-gray-700/60 rounded-lg shadow-xs">
                                    ...
                                    <div class="grow flex items-center truncate mb-2">
                                            <IconCircle class={'w-8 h-8 shrink-0 flex items-center justify-center bg-gray-700 rounded-full mr-2'}/>
                                        <div class="truncate">
                                    ...
                                    <div class="flex justify-between items-center">
                                        ...
                                        <div class="flex -space-x-3 -ml-0.5">
                                            <Avatar name={user()?.name} src={src()} class={'rounded-full bg-gray-3 size-24 ring-2 ring-white lg:size-12'}/>
                                            <Avatar name={user()?.name} src={src()} class={'rounded-full bg-gray-3 size-24 ring-2 ring-white lg:size-12'}/>
                                        </div>
                                        {/* Link */}
                                        <div>
                                            <a class="text-sm font-medium text-violet-500 hover:text-violet-600 dark:hover:text-violet-400" href="#0">
                                                View -&gt;
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <li class="sm:flex sm:items-center sm:justify-between">
                                        ...
                                        <div class="sm:ml-2 mt-2 sm:mt-0">
                                            <ul class="flex flex-wrap sm:justify-end -m-1">
                                                <li class="m-1">
                                                    <button class="inline-flex items-center justify-center text-xs font-medium leading-5 rounded-full px-2.5 py-0.5 border border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 shadow-xs bg-white dark:bg-gray-800 text-gray-500 dark:text-gray-400 transition">
                                                        Marketing
                                                    </button>
                                                </li>
                                                <li class="m-1">

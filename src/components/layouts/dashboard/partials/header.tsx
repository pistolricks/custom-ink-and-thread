...
const Header: Component<PROPS> = props => {
  ...
  const [getSearchModalOpen, setSearchModalOpen] = createSignal<boolean>(false)
        ...
        <div class={`flex items-center justify-between h-16 ${variant() === 'v2' || variant() === 'v3' ? '' : 'lg:border-b border-gray-200 dark:border-gray-700/60'}`}>
          ...
          <div class="flex">
            ...
            <button
              ...
              aria-expanded={getSidebarOpen()}
              onClick={(p) => { setSidebarOpen(!p) }}
            >
          ...
          <div class="flex items-center space-x-3">
            <div>
              <button
                class={`w-8 h-8 flex items-center justify-center hover:bg-gray-100 lg:hover:bg-gray-200 dark:hover:bg-gray-700/50 dark:lg:hover:bg-gray-800 rounded-full ml-3 ${getSearchModalOpen() && 'bg-gray-200 dark:bg-gray-800'}`}

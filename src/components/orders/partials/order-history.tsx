...
const OrderHistory: Component<PROPS> = props => {
                            ...
                            <li class="p-4 sm:p-6">
                                <div class="flex items-center sm:items-start">
                                    <div class="size-20 shrink-0 overflow-hidden rounded-lg bg-gray-200 sm:size-40">
                                        <img
                                            src="https://tailwindcss.com/plus-assets/img/ecommerce-images/order-history-page-03-product-01.jpg"
                                ...
                                <div class="mt-6 sm:flex sm:justify-between">
                                    ...
                                    <div
                                        class="mt-6 flex items-center divide-x divide-gray-200 border-t border-gray-200 pt-4 text-sm font-medium sm:ml-4 sm:mt-0 sm:border-none sm:pt-0">

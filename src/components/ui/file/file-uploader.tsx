...
import {IconCircle, IconX} from "~/components/ui/svg";
            ...
            <div class={'items-center flex flex-row-reverse space-x-4 space-x-reverse py-3'}>
                <Dialog.Close contextId={'albd1'} class={''}>
                    <Button as={"button"} variant={'default'} class={'bg-white'} size={"icon"}
                            type={"submit"}><IconCircle class={'stroke-sky-11 p-1 size-12 fill-sky-2'}/></Button>
                </Dialog.Close>
                <Dialog.Close contextId={'albd1'} class={''}>
                    <Button as={"button"} variant={'default'} class={'bg-white'} size={"icon"} type={"button"}><IconX class={'size-12 p-1.5 stroke-sky-11'}/></Button>
                </Dialog.Close>
            </div>
        </form>
    )

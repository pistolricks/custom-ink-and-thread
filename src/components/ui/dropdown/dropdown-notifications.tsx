    ...
    <Menu as="div" class="relative inline-flex">
      {({ open }) => (
        <>
          ...
          <Transition
            as="div"
            class={`origin-top-right z-10 absolute top-full -mr-48 sm:mr-0 min-w-[20rem] bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700/60 py-1.5 rounded-lg shadow-lg overflow-hidden mt-1 ${
          ...
          >
            ...
            <MenuItems as="ul" class="focus:outline-hidden">
              <MenuItem as="li" class="border-b border-gray-200 dark:border-gray-700/60 last:border-0">
                {({ active }) => (
                  <Link class={`block py-2 px-4 ${active && 'bg-gray-50 dark:bg-gray-700/20'}`} href="#0">
                    <span class="block text-sm mb-2">
                      📣 <span class="font-medium text-gray-800 dark:text-gray-100">Edit your information in a swipe</span> Sint occaecat cupidatat non proident,
              ...
              <MenuItem as="li" class="border-b border-gray-200 dark:border-gray-700/60 last:border-0">
                {({ active }) => (
                  <Link class={`block py-2 px-4 ${active && 'bg-gray-50 dark:bg-gray-700/20'}`} href="#0">
                    <span class="block text-sm mb-2">
                      🚀<span class="font-medium text-gray-800 dark:text-gray-100">Say goodbye to paper receipts!</span> Sint occaecat cupidatat non proident, sunt

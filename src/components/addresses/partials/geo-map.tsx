...
import {Feature as GeoFeature, FeatureCollection} from "~/lib/store";
        ...
        <>
            ...
            <DrawerContent side={getIsDesktop() ? 'right' : 'bottom'} contextId={contextId()}>
                <div class={'h-screen w-full relative'}>
                    ...
                    <AddressSearchForm onClick={handleDrawer} contextId={contextId()} class={'absolute inset-x-0 top-0 py-3 px-2.5'}/>
                    <div
                        style={{
                            height: getHeight() + 'px',
                        }}
